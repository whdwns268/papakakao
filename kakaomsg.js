...
async function kakaoScrape(userData) {
    let vacationData = [];  // vacationData 변수를 초기화
        ...
        const dynamicUrl = `https://center-pf.kakao.com/_xmnHyb/chats/4856752757799108`;
...
console.log("test1")
// JavaScript를 사용하여 #chatWrite 요소의 value를 변경
try{
      await page.click('#chatWrite');
      //await page.keyboard.type('메시지테스트');
}catch(e){
    console.log(e);
}
